    ...
    return (
        <div className="w-full h-44  flex items-start border-2 rounded-lg p-2 mb-2 hts relative">
           ...
           onClick={()=>setIsOpen(true)} >
            ...
            <img className="hidden md:block w-2/5 h-40"
             src={`https://res.cloudinary.com/dt3fknrkp/image/upload/v1621059929/services/${service.seller_id}_${service.service}.jpg`} />
